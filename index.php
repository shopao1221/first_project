...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" style="padding-top:150px;">
    ...
    <div class="container-fluid top-nav">
        ...
        <button class="navbar-toggler" type="button" data-toggle="modal" data-target="#exampleModal1" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        </nav>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <hr class="mt-0">
            ...
            <ul style="list-style-type:none;padding: 0 0 0 20px; margin: 0;">
                <li class="p-3">
                    <a class="a-color" href="#"><i class="fas fa-star-of-life"></i><span style="margin-left: .5rem;">STUDY DESIGN</span> </a>
                </li>
                <li class="p-3">
                <a class="a-color" href="#"><i class="fab fa-sourcetree"></i><span style="margin-left: .5rem;">references</span> </a>
                </li>
                <li class="p-3 ml-1">
                <a class="a-color" href="#"><i class="fas fa-info"></i><span style="margin-left: .5rem;">important safety impormation</span> </a>
                </li>
            </ul>
            <hr class="mt-0">
      </div>
...
<div class="card" style="border:none;">
  ...
  <div class="row">
    ...
    <div class="col-5">
    <img src="image/logo.png" class="rounded float-left" alt="..." style="height:100px; padding-left:20rem;">
    </div>
  </div>
  </div>
</div>
...
<div class="container mt-5">
        ...
        <div class="row">
        <div class="section-title col-md-6" style="padding-top: 4rem;">
            
            <h1 class="titles">ELSA</h1>
            <hr class="c-hr mt-0 mb-2" style="margin-left:2.4rem;">
            <ul style="color: #49A945;"> 
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;"> Moderate to severe-plaque psoriasis.</p></li>
                <hr class="c-hrs">
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;"> Dissatisfied with her level of skin clearance.</p></li>
                <hr class="c-hrs"> 
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;"> Plateaued on current treatment with residual plaques</p></li>
                <hr class="c-hrs">
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;"> Psoriasis is affecting her daily life activity.</p></li>
                <hr class="c-hrs">
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;">Uncomfortable about touching others or being  touched by others.</p></li>
                <hr class="c-hrs">
                <li><p style="font-size: larger;font-weight: 600;color: #315F6F;">Eager to see complete clearance that lasts, with rapidly visible result.</p></li>
                <hr class="c-hrs">
              </ul>
          </div>
          <div class="col-md-6">
            <img src="image/elsa.jpg" alt="" style="height: 80%;width: 100%;margin-left: 7rem;">
          </div>
        </div>
</div>
...
<div class="card" style="border:none;">
  ...
  <div class="row">
    <div class="col-7">
      <p class="mb-0 pl-5" style="color: #B1BCC0;font-siza: 1.2rem;font-weight: 600;">BURDEN OF DISEASE: <span style="color: #465364;">Patient Expectations</span></p>
      <p class="pl-5" style="color: #4BAB47;font-size: xx-large;">Patient expectations from psoriasis treatment <br> (PsoBest registry)<span style="font-size:1rem;">1</span></p>
    </div>
    <div class="col-5">
    <img src="image/logo.png" class="rounded float-left" alt="..." style="height:100px; padding-left:20rem;">
    </div>
